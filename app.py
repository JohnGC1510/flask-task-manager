...
def search():
    ...
    """ $text $search means peform a search other a text index from this
    collection we created a index to allow searching through tasks
...
def add_task():
    if request.method == "POST":
        ...
        # make a dictionary item from the submitted form to send to database
        task = {
...
@app.route("/edit_categroy/<category_id>", methods=["GET", "POST"])
def edit_category(category_id):
    if request.method == "POST":
        ...
        flash("Catergory successfully updated")
        return redirect(url_for("get_categories"))
